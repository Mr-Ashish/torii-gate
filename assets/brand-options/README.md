...
Code-generated pure SVG heroes for the Torii README. Open each file (or view this page on GitHub) and pick a winner.
...
- `assets/torii-hero-banner.svg` ← chosen file  
