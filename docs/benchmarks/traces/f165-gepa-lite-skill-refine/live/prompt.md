...
- `skill-prefer-memory-cli-early`: hits=59 tenants=3 tool_hits=1 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=26 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=15 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=4 tenants=1 tool_hits=0 Δprio=+21 bin=hit
...
- `skill-prefer-hub-archival-early`: hits=14 tenants=1 tool_hits=1 gap_hits=1 Δprio=+34 bin=hit
- Hub-archival util_ok hits=13 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
