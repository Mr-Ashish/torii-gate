...
- Pre-assembled context: `/Users/[REDACTED]/Documents/experiments/torii/.torii-out-f75-pytorch/context.md`
- Unified diff file: `/Users/[REDACTED]/Documents/experiments/torii/.torii-out-f75-pytorch/pr.diff`
...
- `command_injection` hits=10 keywords=[command injection, shell=true, os command, rce, subprocess]
- `insecure_deserialization` hits=10 keywords=[pickle, deserialize, deserialization, unsafe load, cwe-502]
- `secrets_exposure` hits=10 keywords=[secret, api key, api_key, openrouter, credential]
- `sql_injection` hits=10 keywords=[sql injection, sqli, f-string, f"select, string-formatted]
...
- `command_injection` theme=command_injection cwe=CWE-78 hits=14 tenants≈8 keywords=[command injection, shell=true, os command, rce, subprocess, cwe-78]
- `insecure_deserialization` theme=insecure_deserialization cwe=CWE-502 hits=14 tenants≈8 keywords=[pickle, deserialize, deserialization, unsafe load, cwe-502, pickle.loads]
- `secrets_exposure` theme=secrets_exposure cwe=CWE-200,CWE-798 hits=14 tenants≈8 keywords=[secret, api key, api_key, openrouter, credential, exposes]
- `sql_injection` theme=sql_injection cwe=CWE-89 hits=14 tenants≈8 keywords=[sql injection, sqli, f-string, f"select, string-formatted, execute(f]
...
**Recent fitness averages:** path_evidence=0.95, procedure=0.94, tool_use=0.75, chain_quality=0.70, composite=0.87
