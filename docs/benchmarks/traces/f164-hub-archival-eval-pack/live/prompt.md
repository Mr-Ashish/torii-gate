...
- `skill-prefer-memory-cli-early`: hits=53 tenants=3 tool_hits=1 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=17 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=9 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=1 tenants=1 tool_hits=0 Δprio=+15 bin=hit
- **Hub gap pressure=0.39** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
...
- `skill-prefer-hub-archival-early`: hits=6 tenants=1 tool_hits=1 gap_hits=1 Δprio=+30 bin=hit
- Hub-archival util_ok hits=5 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
