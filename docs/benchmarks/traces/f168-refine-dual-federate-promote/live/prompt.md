...
- `skill-prefer-memory-cli-early`: hits=90 tenants=3 tool_hits=1 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=78 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=45 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=25 tenants=1 tool_hits=0 Δprio=+29 bin=hit
...
- `skill-prefer-hub-archival-early`: hits=62 tenants=1 tool_hits=1 gap_hits=1 Δprio=+34 bin=hit
- Hub-archival util_ok hits=61 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
