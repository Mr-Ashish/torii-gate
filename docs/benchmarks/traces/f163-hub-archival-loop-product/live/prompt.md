...
- `skill-prefer-memory-cli-early`: hits=49 tenants=3 tool_hits=1 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=12 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=5 tenants=1 tool_hits=1 Δprio=+26 bin=hit
- **Hub gap pressure=0.40** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
