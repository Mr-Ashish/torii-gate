...
- `skill-prefer-memory-cli-early`: hits=43 tenants=3 tool_hits=0 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=7 tenants=1 tool_hits=1 Δprio=+30 bin=hit
- `skill-prefer-product-cli`: hits=1 tenants=1 tool_hits=0 Δprio=+15 bin=hit
- **Hub gap pressure=0.46** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
