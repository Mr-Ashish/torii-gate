...
- `skill-prefer-memory-cli-early`: hits=67 tenants=3 tool_hits=0 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=40 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=9 tenants=1 tool_hits=0 Δprio=+29 bin=hit
- `skill-prefer-product-cli`: hits=22 tenants=1 tool_hits=0 Δprio=+29 bin=hit
- **Hub gap pressure=0.38** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
...
- `skill-prefer-hub-archival-early`: hits=26 tenants=1 tool_hits=1 gap_hits=1 Δprio=+34 bin=hit
- Hub-archival util_ok hits=25 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
