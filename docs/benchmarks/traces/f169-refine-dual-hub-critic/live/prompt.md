...
- `skill-prefer-memory-cli-early`: hits=104 tenants=3 tool_hits=0 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=104 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=36 tenants=1 tool_hits=0 Δprio=+29 bin=hit
- `skill-prefer-product-cli`: hits=58 tenants=1 tool_hits=0 Δprio=+29 bin=hit
- **Hub gap pressure=0.35** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
...
- `skill-prefer-hub-archival-early`: hits=86 tenants=1 tool_hits=1 gap_hits=1 Δprio=+34 bin=hit
- Hub-archival util_ok hits=85 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
...
- `skill-prefer-memory-cli-early`: local hits=2 tenants=1 tool_pp=50.0 Δprio=+13 fail_n=0
