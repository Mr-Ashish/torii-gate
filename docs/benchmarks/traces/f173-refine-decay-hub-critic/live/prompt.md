...
- `skill-prefer-memory-cli-early`: hits=182 tenants=3 tool_hits=1 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=245 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=135 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-f74-exploit-scenario`: hits=100 tenants=1 tool_hits=0 Δprio=+29 bin=hit
- Hub util_ok hits=101 — keep recovery tools in the loop.
<!-- /torii-f125-recovery-hub -->
...
- `skill-prefer-hub-archival-early`: hits=222 tenants=1 tool_hits=1 gap_hits=1 Δprio=+34 bin=hit
- Hub-archival util_ok hits=221 — keep hub_boost archival in the loop.
<!-- /torii-f162-hub-archival-hub -->
...
- `skill-prefer-memory-cli-early`: local hits=10 tenants=1 tool_pp=50.0 Δprio=+13 fail_n=0
