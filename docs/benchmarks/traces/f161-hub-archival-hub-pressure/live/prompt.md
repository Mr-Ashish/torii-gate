...
- `skill-prefer-memory-cli-early`: hits=45 tenants=3 tool_hits=0 Δprio=+40 bin=hit
- `skill-prefer-hub-archival-early`: hits=9 tenants=1 tool_hits=1 Δprio=+32 bin=hit
- `skill-prefer-product-cli`: hits=2 tenants=1 tool_hits=0 Δprio=+17 bin=hit
- **Hub gap pressure=0.44** — prefer early recovery CLI tool calls (memory/doctor/critic) before finalizing.
<!-- /torii-f125-recovery-hub -->
