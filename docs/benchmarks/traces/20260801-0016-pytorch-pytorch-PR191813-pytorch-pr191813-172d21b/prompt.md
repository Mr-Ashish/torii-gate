...
- Pre-assembled context: `/Users/[REDACTED]/Documents/experiments/torii/.torii-out-f73-pytorch/context.md`
- Unified diff file: `/Users/[REDACTED]/Documents/experiments/torii/.torii-out-f73-pytorch/pr.diff`
...
- `command_injection` theme=command_injection cwe=CWE-78 hits=6 tenants≈4 keywords=[command injection, shell=true, os command, rce, subprocess, cwe-78]
- `insecure_deserialization` theme=insecure_deserialization cwe=CWE-502 hits=6 tenants≈4 keywords=[pickle, deserialize, deserialization, unsafe load, cwe-502, pickle.loads]
- `secrets_exposure` theme=secrets_exposure cwe=CWE-200,CWE-798 hits=6 tenants≈4 keywords=[secret, api key, api_key, openrouter, credential, exposes]
- `sql_injection` theme=sql_injection cwe=CWE-89 hits=6 tenants≈4 keywords=[sql injection, sqli, f-string, f"select, string-formatted, execute(f]
