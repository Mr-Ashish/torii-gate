```json
{
  ...
  "units": [
    ...
    },
    {
      ...
      "action": "merge",
      "section": "Patterns",
      "content": "- Prompt/contract changes are motivated by rubric evidence, not intuition: a low per-dimension score for tool depth in the 6-PR `torii-eval` corpus on `Mr-Ashish/odoo` justified the F51 feature flag.\n- Each fix was validated by a live mini re-score of the same PR under the new build, illustrating an eval-driven tuning loop.",
      "evidence": [
        "score 34/50 D8=2",
