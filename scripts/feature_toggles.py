...
REGISTRY: list[ToggleSpec] = [
    ...
    ToggleSpec(
        "skill_attribution",
        "TORII_SKILL_ATTRIBUTION",
        "bool",
        True,
        "product",
        "F88 per-skill leave-one-out contribution attribution",
        "F88",
    ),
    ToggleSpec(
        "skill_attr_router",
    ...
    ToggleSpec(
        ...
        True,
        "product",
        "F88 require per-skill attribution>0 (reject free-riders) before adopt",
        "F88",
    ),
    ToggleSpec(
        "skill_router",
    ...
    ToggleSpec(
        ...
        True,
        "product",
        "F105 audit mid-review memory tool utilization (search/graph/…)",
        "F105",
    ),
    ToggleSpec(
        "memory_tool_fitness",
        "TORII_MEMORY_TOOL_FITNESS",
        "bool",
        True,
        "product",
        "F105 soft-blend memory utilization into trajectory fitness",
        "F105",
    ),
    ToggleSpec(
    ...
    ToggleSpec(
        "reprompt_budget",
        "TORII_REPROMPT_BUDGET",
        "bool",
        True,
        "product",
        "F108 shared soft-re-prompt budget across F49+F106",
        "F108",
    ),
    ToggleSpec(
        "reprompt_max_extra",
        "TORII_REPROMPT_MAX_EXTRA",
        "int",
        1,
        "product",
        "F108 max paid soft re-prompt attempts per review (default 1)",
        "F108",
    ),
    ToggleSpec(
        "trace_vault",
