#!/usr/bin/env bash
# Local / manual Torii Gate review helper.
#
# Usage:
...
export OUT_DIR="${OUT_DIR:-$ROOT/.torii-out}"
export HERMES_HOME="${HERMES_HOME:-$ROOT/.torii-hermes-home}"
...
"$ROOT/scripts/run-torii-review.sh"
