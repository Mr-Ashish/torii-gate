#!/usr/bin/env python3
"""Build a size-capped JSON payload for hub repository_dispatch (torii-run)."""
...
MAX_REVIEW_CHARS = int(os.environ.get("TORII_HUB_MAX_REVIEW_CHARS", "14000"))
MAX_SUMMARY_CHARS = int(os.environ.get("TORII_HUB_MAX_SUMMARY_CHARS", "4000"))
...
def main() -> int:
    out_dir = Path(os.environ.get("OUT_DIR", ".torii-out"))
    ...
    model = os.environ.get("TORII_MODEL") or os.environ.get("OPENROUTER_MODEL") or "unknown"
    status = os.environ.get("TORII_STATUS", "unknown")
...
"""
    ...
    # F65: optional multi-tenant hub namespace (also honored via TORII_MEMORY_TENANT at ingest)
    ...
    payload = {
        ...
        "meta": {
            ...
            "started_at": os.environ.get("TORII_STARTED_AT"),
